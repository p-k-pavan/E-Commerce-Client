    ...
    <div className="min-h-screen bg-[#F9FAFB] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#16A34A] relative overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1748342319942-223b99937d4e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmcmVzaCUyMHZlZ2V0YWJsZXMlMjBtYXJrZXR8ZW58MXx8fHwxNzc1Njg3NDEyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
            alt="Fresh groceries"
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-12 text-white">
          ...
          <h1 className="text-5xl font-bold mb-4">Namma Mart</h1>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
            <div className="mb-8">
              ...
              <p className="text-[#6B7280]">Sign in to continue shopping</p>
            </div>
